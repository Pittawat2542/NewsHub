...
public class HFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_blognone, container, false);
    ...
    private void initInstances(View rootView, Bundle savedInstanceState) {
        ...
        rssReader = new RssReader(getActivity(), getContext(),
                recyclerView, isFirstRun, 7);
        rssReader.setWebSite("https://www.blognone.com/atom.xml");
        rssReader.execute();
        isFirstRun = true;
    ...
    private void reloadData() {
        RssReader reloadSeven = new RssReader(getActivity(), getContext(),
                recyclerView, isFirstRun, 7);
        reloadSeven.setWebSite("https://www.blognone.com/atom.xml");
        reloadSeven.execute();
